...
function visKropp() {
    ...
    document.getElementById("kroppSynlig").innerHTML = `
            ...
            <div class="bodyPart" id="hode">
                ...
                <img src="/Eksempel1/pic/head1.png" alt="hode">
            ...
            <div class="bodyPart" id="body">
                ...
                <img src="/Eksempel1/pic/body1.png" alt="kropp">
            ...
            <div class="bodyPart" id="legs">
                ...
                <img src="/Eksempel1/pic/legs1.png" alt="føtter">
...
function selectHead1() {
    ...
    <img src="/Eksempel1/pic/head1.png">
...
function selectHead2() {
    ...
    <img src="/Eksempel1/pic/head2.png">
...
function selectHead3() {
    ...
    <img src="/Eksempel1/pic/head3.png">
...
function selectHead4() {
    ...
    <img src="/Eksempel1/pic/head4.png">
...
function selectBody1() {
    ...
    <img src="/Eksempel1/pic/body1.png">
...
function selectBody2() {
    ...
    <img src="/Eksempel1/pic/body2.png">
...
function selectBody3() {
    ...
    <img src="/Eksempel1/pic/body3.png">
...
function selectBody4() {
    ...
    <img src="/Eksempel1/pic/body4.png">
...
function selectLegs1() {
    ...
    <img src="/Eksempel1/pic/legs1.png">
...
function selectLegs2() {
    ...
    <img src="/Eksempel1/pic/legs2.png">
...
function selectLegs3() {
    ...
    <img src="/Eksempel1/pic/legs3.png">
...
function selectLegs4() {
    ...
    <img src="/Eksempel1/pic/legs4.png">
